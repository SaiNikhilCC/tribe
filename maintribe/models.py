...
class Product(models.Model):
    ...
    discount_1 = models.IntegerField(default=0)
    # Size-2
    ...
    discount_2 = models.IntegerField(default=0)
    # Size-3
    ...
    discount_3 = models.IntegerField(default=0)
    # Size-4
    ...
    discount_4 = models.IntegerField(default=0)
    # Size-5
    ...
    discount_5 = models.IntegerField(default=0)
    # product Status
    ...
    def discount_2(self):
        if self.size_actual_price_2 and self.size_selling_price_2:
            discount = ((self.size_actual_price_2 - self.size_selling_price_2) / self.size_actual_price_2) * 100
            return round(discount, 2)
        return 0

    @property
    def discount_3(self):
        if self.size_actual_price_3 and self.size_selling_price_1:
            discount = ((self.size_actual_price_3 - self.size_selling_price_3) / self.size_actual_price_3) * 100
            return round(discount, 2)
        return 0

    @property
    def discount_4(self):
        if self.size_actual_price_4 and self.size_selling_price_4:
            discount = ((self.size_actual_price_4 - self.size_selling_price_4) / self.size_actual_price_4) * 100
            return round(discount, 2)
        return 0

    @property
    def discount_5(self):
        if self.size_actual_price_5 and self.size_selling_price_5:
            discount = ((self.size_actual_price_5 - self.size_selling_price_5) / self.size_actual_price_5) * 100
            return round(discount, 2)
        return 0
