...
# Global Search API                                                      (Completed)
# Top Selling Products                                                   ()
# Create Custom Product API                                              ()                         
# Orders API                                                             ()
# Coupon API                                                             ()
# Reviews API                                                            ()
# Remove From Cart Should Be Based onn Product ID and User ID            (Completed)
# Remove From Wishlist Should Be Based on Product ID and User ID         (Completed)
